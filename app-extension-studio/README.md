...
A [Stackable Labs](https://stackablelabs.com/) extension template designed for use with the Extension Studio in-browser builder. Contains the minimal scaffolding needed for Studio-generated extensions.
